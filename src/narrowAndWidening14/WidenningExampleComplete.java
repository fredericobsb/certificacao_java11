...
public class WidenningExampleComplete {
    public static void main(String[] args) {
        ...
        // conversion (ยง5.1.2), and then the resulting int is converted to a char by narrowing primitive conversion (ยง5.1.3).
