...
public class StringBuilderManipulation {
    public static void main(String[] args) {
        ...
        StringBuilder testeA = new StringBuilder("abc");
        StringBuilder testeB = new StringBuilder("abc");
        StringBuilder testeC = testeB;
        System.out.println("(testeA == testeB) = " + (testeA == testeB));
        System.out.println("(testeC == testeB) = " + (testeC == testeB));
