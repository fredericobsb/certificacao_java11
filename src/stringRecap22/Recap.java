...
public class Recap {
    ...
    public static void StringConstructors() {
        String s1 = new String("hello");//com new, cria endereços de memoria diferentes.
        String s2 = new String("hello");//com new, cria endereços de memoria diferentes.
